package ru.iteye.androidlivecourseapp.presentation.mvp.auth_vk
...
class AuthVKPresenter: BasePresenter<AuthChooseActivity>() {
    ...
    private fun onUserAuthenticated() {
        ...
        //TODO: следующая инструкция почему-то игнорируется...
